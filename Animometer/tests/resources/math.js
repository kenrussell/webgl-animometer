...
PIDController = Utilities.createClass(
    ...
    _tune: function(t, h, y, e)
    {
        switch (this._stage) {
        case PIDController.stages.WARMING:
            // This is the first stage of the ZieglerÃ¢Â�Nichols method. It increments
        ...
        case PIDController.stages.OVERSHOOT:
            // This is the second stage of the ZieglerÃ¢Â�Nichols method. It measures the
            // oscillation period.
        ...
        case PIDController.stages.UNDERSHOOT:
            // This is the end of the ZieglerÃ¢Â�Nichols method. We need to calculate the
